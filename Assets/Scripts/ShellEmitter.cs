...
public class ShellEmitter : MonoBehaviour {
    ...
    private void Fire()
    {
        ...
        //we use Prefab because emitter shoot multiple times a shell

        if (shellPrefab != null) //if  there is no template instance in the scene, create one
        {   //if want to reuse a gameobject configured in a particular way in multiple places in your scene,
            //or across multiple scenes in your project, convert it to a prefab
